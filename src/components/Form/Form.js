...
const Form = ({ currentId, setCurrentId }) => {
  const [postData, setPostData] = useState({creator:'', logo:'',companyName: '',description:'',map:'',phoneNumber:'' ,productFileOne:'' , category: null 
  ,productFileTwo: '',
  productFileThree: '',
  productFileFour: '' });
  ...
  const clear = () => {
    setCurrentId(0);
    setPostData({companyName: '',logo:'', description:'',map:'',phoneNumber:'' ,productFileOne:''  ,productFileTwo: '',productFileThree: '', productFileFour: '', category: null});
  };
